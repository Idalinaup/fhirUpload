...
<div class="form-group">
    <input type="number" class="form-control" placeholder="Type a number" name="{{$item->getLinkId()}}[]" id="{{$item->getLinkId()}}" value="{{ $initialValue }}" {{ ($item->getreadOnly() == "true") ? "disabled" : "" }}>
</div>